...
reactions = {'GluKin','PGI','PFK','ALD','TPI','GAPDH','PGK','ENO','PYK','PDH','AAR','PFL','AlcDH','G6PDH','GLNdeh','KDPGald','PKT','PTA','TALA','TKT1','RibIso','RibEpi','TKT2','FBPase','ATPM','PHBs'};
...
for j=1:3
   ...
   % Writing the output files
    ...
    global_table = vertcat(global_table,T2);
        ...
        for i=1:length(reactions)
        text(axis_x(i),axis_y(i)+13*(j-1),labels(i),'FontSize',8,'Color',colors(j,:));
        end
